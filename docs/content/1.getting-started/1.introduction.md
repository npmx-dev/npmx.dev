...
- **Share exact views** - Package versions, code files, diffs, docs, changelogs, timelines, stats, search, and compare states are URL-driven
...
- Share a permalink to the exact package, code, docs, diff, changelog, timeline, stats, search, or comparison view

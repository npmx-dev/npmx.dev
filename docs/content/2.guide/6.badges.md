...
- **vulnerabilities**: Shows the number of known vulnerabilities (found via OSV). Renders a gray `unknown` badge when the scan could not be performed, so a failed check is never mistaken for a clean result. :img{src="https://img.shields.io/badge/%2322c55e-22c55e" class="inline align-middle h-5 w-14"} / :img{src="https://img.shields.io/badge/%23ef4444-ef4444" class="inline align-middle h-5 w-14"} / :img{src="https://img.shields.io/badge/%2364748b-64748b" class="inline align-middle h-5 w-14"}

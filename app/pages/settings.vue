    ...
    <article class="max-w-2xl mx-auto">
      ...
      <header class="mb-12">
        <div class="flex items-baseline justify-between gap-4 mb-4">
          ...
          <button
            type="button"
            class="inline-flex items-center gap-2 font-mono text-sm text-fg-muted hover:text-fg transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 shrink-0"
            @click="router.back()"
          >
          ...
          <div class="bg-bg-subtle border border-border rounded-lg p-4 sm:p-6 space-y-6">
            ...
            <div class="space-y-2">
              ...
              <select
                ...
                class="w-full sm:w-auto min-w-48 bg-bg border border-border rounded-md px-3 py-2 text-sm text-fg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 cursor-pointer"
                @change="
          ...
          <div class="bg-bg-subtle border border-border rounded-lg p-4 sm:p-6 space-y-4">
            ...
            <template v-else>
              <a
                ...
                class="inline-flex items-center gap-2 text-sm text-fg-muted hover:text-fg transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 rounded"
              >

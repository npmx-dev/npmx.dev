            ...
            <div class="space-y-1 sm:col-span-2">
              ...
              <dd class="font-mono text-sm text-fg flex items-center gap-2 flex-wrap">
                ...
                >
                  <span
                    tabindex="0"
                    class="inline-flex items-center gap-1 px-1.5 py-0.5 text-2xs font-sans rounded bg-amber-500/15 text-amber-700 dark:text-amber-400 border border-amber-500/30 cursor-help focus-visible:outline-2 focus-visible:outline-accent/70"
                  >

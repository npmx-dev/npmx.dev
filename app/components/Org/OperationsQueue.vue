  ...
  <div v-if="isConnected" class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        <button
          v-if="hasOperations"
          type="button"
          class="px-2 py-1 font-mono text-xs text-fg-muted hover:text-fg bg-bg-subtle border border-border rounded transition-colors duration-200 hover:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
        ...
        <button
          type="button"
          class="p-1 text-fg-muted hover:text-fg transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
      ...
      >
        ...
        <div class="flex-shrink-0 flex items-center gap-1">
          <button
            ...
            type="button"
            class="p-1 text-fg-muted hover:text-green-400 transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
          ...
          <button
            ...
            type="button"
            class="p-1 text-fg-muted hover:text-red-400 transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
    ...
    >
      ...
      <form class="flex items-center gap-2" @submit.prevent="handleRetryWithOtp">
        ...
        <input
          ...
          spellcheck="false"
          class="flex-1 px-3 py-1.5 font-mono text-sm bg-bg border border-border rounded text-fg placeholder:text-fg-subtle transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
        />
        <button
          type="submit"
    ...
    <div v-if="hasActiveOperations" class="flex items-center gap-2 pt-2">
      <button
        ...
        type="button"
        class="flex-1 px-4 py-2 font-mono text-sm text-fg bg-bg-subtle border border-border rounded-md transition-colors duration-200 hover:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
      ...
      <button
        ...
        class="flex-1 px-4 py-2 font-mono text-sm text-bg bg-fg rounded-md transition-all duration-200 hover:bg-fg/90 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
        @click="handleExecute()"
      >
        {{
          isExecuting
    ...
    <details v-if="hasCompletedOperations" class="mt-4 border-t border-border pt-4">
      ...
      <ul class="mt-2 space-y-1" :aria-label="$t('operations.queue.log_label')">
        ...
        >
          ...
          <button
            type="button"
            class="p-0.5 text-fg-subtle hover:text-fg-muted transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"

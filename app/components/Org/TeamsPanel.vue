    ...
    <ul v-else class="divide-y divide-border" :aria-label="$t('org.teams.list_label')">
      <li v-for="teamName in filteredTeams" :key="teamName" class="bg-bg">
        ...
        >
          <button
            type="button"
            class="flex-1 flex items-center gap-2 text-start rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
        ...
        >
          ...
          <button
            v-else
            type="button"
            class="mt-2 px-2 py-1 font-mono text-xs text-fg-muted hover:text-fg transition-colors duration-200 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
        ...
        <form class="flex items-center gap-2" @submit.prevent="handleCreateTeam">
          <div class="flex-1 flex items-center">
            ...
            <input
              ...
              v-bind="noCorrect"
              class="flex-1 px-2 py-1.5 font-mono text-sm bg-bg border border-border rounded-ie text-fg placeholder:text-fg-subtle transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"
            />
          </div>
          <button
            type="submit"

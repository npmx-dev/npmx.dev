      ...
      <form class="space-y-2" @submit.prevent="handleGrantAccess">
        <div class="flex items-center gap-2">
          ...
          <select
            ...
            name="grant-team"
            class="flex-1 px-2 py-1.5 font-mono text-sm bg-bg-subtle border border-border rounded text-fg transition-colors duration-200 focus:border-border-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50"

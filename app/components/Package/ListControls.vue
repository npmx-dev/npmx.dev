    ...
    <div class="relative shrink-0 flex">
      ...
      <div class="relative">
        <select
          id="package-sort"
          v-model="sortValue"
          class="appearance-none bg-bg-subtle border border-border rounded-lg ps-3 pe-8 py-3 leading-none font-mono text-sm text-fg cursor-pointer transition-colors duration-200 focus:(border-border-hover outline-none) hover:border-border-hover"
        >
